...
object SubmissionQueries extends BaseQueries[Submission] {
  ...
  override protected val columns = Seq("contest_id", 
    "user_id", "submission_date", "submission_notes","score")
  ...
  override protected def fromRow(row: Row) = {
    ...
    val submission_date = row.as[LocalDate]("submission_date")
    val submissions_notes = row.as[String]("submission_notes")
